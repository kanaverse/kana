import * as hdf5 from "./HDF5Reader.js";
...
export function results(wasm) {
  var output = { "dimensions": fetchDimensions(wasm) };
...
/** Custom exports **/
export function fetchCountMatrix(wasm) {
  if ("reloaded" in cache) {
...
export function fetchDimensions(wasm) {
  if ("reloaded" in cache) {
    return {
